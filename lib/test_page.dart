...
class _TestPageState extends State<TestPage> {
  ...
  void loadUser() async {
    ...
    if (user != null) {
      ...
      // log('TestPage Init uid: ${user.uid}');
      // log('TestPage Init email: ${user.email}');
      // log('TestPage Init name: ${user.displayName}');
      // log('TestPage Init: Email Verified: ${user.emailVerified}');
      // log('TestPage Init photo: ${user.photoURL}');
      // log('TestPage Init number: ${user.phoneNumber}');
    } else {
      log('TestPage: user null');
    }
    ...
    // log('TestPage: onBoading $isBoadingScreenDone');
    // log('TestPage: user login or not $isLogintest');
    // log('TestPage: login is skipped $isLoginSkipped');
    // log('TestPage: countary: $countory');
    // log('TestPage: languages: $languages');
    // log('TestPage: photo: $profilephoto');
